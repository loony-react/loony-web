  ...
  return (
    <ul>
      ...
      authContext.user?.uid === mainNode.user_id ? (
        <>
          <li className="flex items-center gap-2 hover:text-blue-500 px-3 py-1 rounded transition">
            <Link to={`/view/${docType}/${doc_id}`}>View</Link>
          </li>
          <li
            onClick={deleteDoc}
            className="flex items-center gap-2 hover:text-blue-500 px-3 py-1 rounded transition"
          >
            <Link to="#">Delete</Link>
          </li>
        </>
